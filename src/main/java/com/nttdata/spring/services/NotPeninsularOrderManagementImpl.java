 ...
 * Taller 2 Spring
 * 
 * Implementación servicio gestión de pedidos fuera de la peninsula
 * 
 * @author ernestocf
 *
 */
@Service("notPeninsularOrderService")
public class NotPeninsularOrderManagementImpl implements OrderManagementServiceI {
	...
	public void addProductsToOrder(Products product, Order order) {
		product.setPriceWithTaxes(product.getPriceWOTaxes() * 1.04f);
